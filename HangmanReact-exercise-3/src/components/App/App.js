...
const wordGuessed = (word, guessedLetters) => {
  ...
  let remaining = word.filter(
    letter => !guessedLetters.includes(letter) //FOUND ERROR - guessedLetters should NOT include letter    //otherwise remaing.length === 0 at start of game and wordGuessed will return true
  );
